...
const ICON_CURSOR = `<svg width="12" height="13" viewBox="0 0 12 13" fill="none" style="flex-shrink:0;image-rendering:pixelated" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="0" width="2" height="6" fill="currentColor"/><rect x="1" y="5" width="1" height="1" fill="currentColor"/><rect x="1" y="6" width="8" height="1" fill="currentColor"/><rect x="0" y="7" width="9" height="2" fill="currentColor"/><rect x="1" y="9" width="8" height="1" fill="currentColor"/><rect x="1" y="10" width="7" height="1" fill="currentColor"/><rect x="2" y="11" width="5" height="1" fill="currentColor"/><rect x="3" y="12" width="3" height="1" fill="currentColor"/></svg>`;
