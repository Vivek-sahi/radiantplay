 ...
 * two names collided once the duration list moved to `_shared/caching/windows.ts` to be shared
...
/**
 * Cache durations come from `_shared/caching/windows.ts` — **one list, shared with Data Studio's
 ...
 */
import type { CacheWindow as SharedCacheWindow } from '../_shared/caching/windows';
export type { CacheWindow } from '../_shared/caching/windows';
