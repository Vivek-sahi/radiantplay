...
const WORKFLOWS = [
  ...
  { num: '02', name: 'Create a new project',        desc: 'Import structure and start building a data model' },
  { num: '03', name: 'Build / modify a project',    desc: 'Add tables, define joins, manage columns' },
  { num: '04', name: 'Coach a project',             desc: 'Write context, synonyms, and semantic metadata' },
  { num: '05', name: 'Test a project',              desc: 'Run tests, identify gaps, route fixes' },
  { num: '06', name: 'Cache a project',             desc: 'Enable caching and set refresh frequency' },
  { num: '07', name: 'Prep data quality',           desc: 'Scan, review, and apply data quality fixes' },
  { num: '08', name: 'Publish a project',           desc: 'Set access and make the project live for Spotter' },
