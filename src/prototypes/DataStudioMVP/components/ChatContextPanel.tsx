  ...
  const renderItem = (item: CreatedItem, i: number, hovered: number | null, setHovered: (v: number | null) => void) => (
    <div key={i}>
      ...
      {item.actions && item.actions.length > 0 && (
        <div style={{ paddingLeft: sp.G, display: 'flex', gap: sp.C, paddingBottom: sp.A }}>
          ...
          {environmentOpen && (
            <div style={{ padding: `0 ${sp.C}px ${sp.C}px`, display: 'flex', flexDirection: 'column' }}>
              ...
              {(() => {
                ...
                return (
                  <div style={{ display: 'flex', alignItems: 'center', gap: sp.A, padding: `2px ${sp.B}px`, marginTop: 1 }}>
        ...
        <div style={{ padding: `0 ${sp.C}px ${sp.C}px`, display: 'flex', flexDirection: 'column', gap: sp.C }}>
          {!hasContext ? (
            ...
            <>
              ...
              {models.length > 0 && (
                <div>
                  <div style={{ fontSize: fs.xs, color: secondaryColor, fontWeight: fw.medium, padding: `0 ${sp.B}px`, marginBottom: sp.A }}>Models</div>
                  {models.map((m, i) => (
                    <div
                      key={i}
              ...
              {tables.length > 0 && (
                <div>
                  <div style={{ fontSize: fs.xs, color: secondaryColor, fontWeight: fw.medium, padding: `0 ${sp.B}px`, marginBottom: sp.A }}>Tables</div>
                  {tables.map((t, i) => (
                    <div
                      key={i}
              ...
              {(sourceTableItems.length > 0 || pendoFetchComplete) && (
                <div>
                  <div style={{ fontSize: fs.xs, color: secondaryColor, fontWeight: fw.medium, padding: `0 ${sp.B}px`, marginBottom: sp.A }}>Source tables</div>
                    ...
                    <>
                      ...
                      {sourceTableItems.map((item, i) => (
                        ...
                        >
                          ...
                          <span style={{ fontSize: 12, fontWeight: fw.semibold, color: c['content-secondary'], backgroundColor: c['background-subtle'], border: `1px solid ${c['border-default']}`, borderRadius: 3, padding: '1px 4px', flexShrink: 0, letterSpacing: '0.02em' }}>CDW</span>
                        </div>
                      ))}
                      <div style={{ fontSize: fs.xs, color: c['content-tertiary'], padding: `2px ${sp.B}px`, marginTop: sp.A, marginBottom: pendoFetchComplete ? sp.B : 0 }}>
                  ...
                  {pendoFetchComplete && (
                    ...
                    >
                      ...
                      <span style={{ fontSize: 12, fontWeight: fw.semibold, color: c['content-secondary'], backgroundColor: c['background-subtle'], border: `1px solid ${c['border-default']}`, borderRadius: 3, padding: '1px 4px', flexShrink: 0, letterSpacing: '0.02em' }}>API</span>
                    </div>
                  )}
                </div>
              )}
              ...
              {skills.length > 0 && (
                <div>
                  <div style={{ fontSize: fs.xs, color: secondaryColor, fontWeight: fw.medium, padding: `0 ${sp.B}px`, marginBottom: sp.A }}>Skills</div>
                  {skills.map((s, i) => (
                    <div key={i} style={{ display: 'flex', alignItems: 'center', gap: sp.B, padding: `4px ${sp.B}px` }}>
