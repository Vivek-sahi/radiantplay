...
interface ReasoningBlockProps {
  ...
  // 'lg' bumps the header to 16px and the step content to 14px — used by the
  // fullscreen onboarding chat only. Defaults to the compact panel sizing.
  size?: 'default' | 'lg';
}

export const ReasoningBlock: React.FC<ReasoningBlockProps> = ({ data, onExpandChange, size = 'default' }) => {
