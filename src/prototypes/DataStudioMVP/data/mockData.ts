...
export const tableMetadata: Record<string, TableMeta> = {
  ...
  transactions: {
    ...
    rowCount: 2_300_000, lastSynced: '2024-03-28T14:32:00Z', qualityIssues: [],
    columns: [
  ...
  accounts: {
    ...
    rowCount: 48_000, lastSynced: '2024-03-28T14:32:00Z', qualityIssues: [],
    columns: [
      { id: 'account_id',     name: 'account_id',     type: 'string', description: null, nullable: false },
      { id: 'company_name',   name: 'company_name',   type: 'string', description: null, nullable: false },
      { id: 'industry',       name: 'industry',       type: 'string', description: null, nullable: false },
  ...
  dim_accounts: {
    ...
    rowCount: 48_000, lastSynced: '2024-03-28T06:00:00Z', qualityIssues: [],
  ...
  support_cases: {
    ...
    rowCount: 4_200_000, lastSynced: '2024-03-28T06:00:00Z', qualityIssues: [],
  ...
  call_metrics: {
    ...
    rowCount: 12_400_000, lastSynced: '2024-03-28T06:00:00Z', qualityIssues: [],
  ...
  customer_found_defects: {
    ...
    rowCount: 1_800_000, lastSynced: '2024-03-28T06:00:00Z', qualityIssues: [],
  ...
  pendo_nps_enriched: {
    ...
    rowCount: 2_600_000, lastSynced: '2024-03-28T14:55:00Z', dqScore: 92, owner: 'Agent (pendo_nps_ingestion.ipynb)', qualityIssues: [],
    sampleRows: [
  ...
  csm_account_mapping: {
    ...
    rowCount: 1_240, lastSynced: '2024-03-28T14:56:00Z', dqScore: 98, owner: 'Agent (CSV upload)', qualityIssues: [],
    sampleRows: [
